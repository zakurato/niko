...
<body>
    ...
    <br>
        ...
        <a href="https://api.whatsapp.com/send?phone=50687249099&text=DATOS DE COMPRA!!!%0aNombre:%20{{$store->nombre}}%0aCedula:%20{{$store->cedula}}%0aTeléfono:%20{{$store->telefono}}%0aLink con los datos:%20http://54.237.32.55/mostrar/factura/tenis/{{$store->id}}">
