...
<head>
    ...
    <link rel="stylesheet" href="{{asset("ventasCss/guias.Css")}}">
    <title>guiaTallas</title>
</head>
<body>
    ...
    <br>
    <a href="{{route("mostrarProducto","$id")}}">
        <button class="btnVolver">Volver</button>
    </a>
    <br><br>
    <h1 style="text-align: center">Guía de tallas Universal</h1>
        
            <div class="tableFixHead">
                <table>
                  <thead>
                    <tr>
                        <th class="head">US - Hombre</th>
                        <th class="head">US - Mujer</th>
                        <th class="head">US - Niño</th>
                        <th class="head">UK</th>
                        <th class="head">CM</th>
                        <th class="head">EU</th>
                    </tr>
