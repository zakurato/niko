...
<body>
  ...
  <div class="section" id="section-1">
    ...
    <h1 style="font: 250% Arial; font-weight: 1000">Calzado</h1>
    <br>
    ...
    <form method="POST" action="{{route("storeTenis")}}" accept-charset="UTF-8" enctype="multipart/form-data">
        @csrf
      ...
      <div class="form-group">
        ...
        <div id="mainselection">
          <select name="categoria" id="selectOption" required>
            <option value="">-</option>
